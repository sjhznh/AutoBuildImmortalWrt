...
#================存在问题====================
# 1.zerotier安装后在单位的电脑无法连接 2.需解决指定eth1未wan口 
# 首页和网络向导
...
# 同样是代理相关 但以下2个属于imm仓库内的软件 一般在build24.sh中已经集成 你也可以在此处调整它的去留 若去除组件则使用减号- 若添加则 不使用减号 或者 不处理。注意这个开启导致无法编译进去，要备注#-自己已测试结果
